...
const Repos = () => {
  ...
  const languages = repos.reduce((total, item) => {
    ...
    if (!total[language]) {
      total[language] = { label: language, value: 1, stars: stargazers_count } //set dynami property to object ie total['property name']
    }
    else {
  ...
  return (
    <>
      {repos.length ? (<section className="section">
